...
template <typename D, typename T, bool C = is_empty_v<D>> class Has {};

template <typename D, typename T> class Has<D, T, false> {
private:
  using current_t = front<D>;

public:
  constexpr static bool value =
      std::is_same_v<current_t, T> ? true : Has<pop_front<D>, T>::value;
};

template <typename D, typename T>
class Has<D, T, true> : public std::false_type {};

////////////////////////////////////////////////////////////////////////////////////////////////

template <typename D, typename T> constexpr bool has_type_v = Has<D, T>::value;

////////////////////////////////////////////////////////////////////////////////////////////////

TEST(test, present_in_container) {
  static_assert(has_type_v<Deque<int, double, class B, int>, int>);
  static_assert(has_type_v<Deque<int, double, class B, int>, double>);
  static_assert(has_type_v<Deque<int, double, class B, int>, class B>);
  static_assert(!has_type_v<Deque<int, double, class B, int>, std::string>);
  static_assert(!has_type_v<Deque<int, double, class B, int>, class A>);
}
